...
import com.tery.edu.litewechat.api.common.Common;
import com.tery.edu.litewechat.util.calendar.ShiChenUtil;
import com.tery.edu.litewechat.util.utils.DateUtils;
...
public class Lunar {
    ...
    private void init(long TimeInMillis) {
        ...
        Calendar baseDate = new GregorianCalendar(Common.Date.EARLYIST_YEAR, 0, 31);
        long offset = (TimeInMillis - baseDate.getTimeInMillis()) / Common.Date.ONE_DAY_MILLIS;
        // 按农历年递减每年的农历天数，确定农历年份
        this.lunarYear = Common.Date.EARLYIST_YEAR;
        ...
        // 农历时辰
        this.lunarHour = ShiChenUtil.convert2SC(String.valueOf(this.solar.get(Calendar.HOUR)));
        // 取得干支历
...
//        String date = "19870307 02";
//        String date2 = "19871114 02:30:02";
//        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd HH");
//        long dateToSecond = sdf.parse(date).getTime();
//        Lunar l = new Lunar(dateToSecond);
//        System.out.println("节气:" + l.getTermString());
//        System.out.println("干支历:" + l.getCyclicalDateString()+l.getLunarHour());
//        System.out.println("属相：" + l.getAnimalString());
...
//    }
    ...
    public static long getbeforesolarTerm(int year, Date date) {
        ...
        return DateUtils.DateDays(date, jieqi.get(jieqibeforeafter[0]));
    ...
    public static long getaftersolarTerm(int year, Date date) {
        List<Date> jieqi = Alljieqi(year);
        int[] jieqibeforeafter = getnearsolarTerm(year, date);
        return DateUtils.DateDays(date, jieqi.get(jieqibeforeafter[1]));
    ...
    public String toString() {
        return "节气:" + this.getTermString() + "\n" +
                "干支历:" + this.getCyclicalDateString() + this.getLunarHour() + "\n" +
                "属相：" + this.getAnimalString() + "\n" +
                "星期" + this.getDayOfWeek() + "\n" +
                "农历" + this.getLunarDateString();
    }
}
